...
object html {
  ...
  /**
    ...
    */
  inline def checked[T]: Attr[T] = checkedAttr := ""

  val checkedAttr: AttrDef = AttrDef(ns, "checked")
  ...
  /**
    ...
    */
  inline def disabled[T]: Attr[T] = disabledAttr := ""

  val disabledAttr: AttrDef = AttrDef(ns, "disabled")
  ...
  /**
    ...
    */
  inline def draggable[T]: Attr[T] = draggableAttr := ""

  val draggableAttr: AttrDef = AttrDef(ns, "draggable")
  ...
  /**
    ...
    * Applicable to <button>, <input>
    */
  inline def formNoValidate[T]: Attr[T] = formNoValidateAttr := ""

  val formNoValidateAttr: AttrDef = AttrDef(ns, "formnovalidate")
  ...
  /**
    ...
    */
  inline def hidden[T]: Attr[T] = hiddenAttr := ""

  val hiddenAttr: AttrDef = AttrDef(ns, "hidden")
  ...
  /**
    ...
    */
  inline def multiple[T]: Attr[T] = multipleAttr := ""

  val multipleAttr: AttrDef = AttrDef(ns, "multiple")
  ...
  /**
    ...
    * Applicable to <input>, <textarea>
    */
  inline def readonly[T]: Attr[T] = readonlyAttr := ""

  val readonlyAttr: AttrDef = AttrDef(ns, "readonly")
  ...
  /**
    ...
    */
  inline def selected[T]: Attr[T] = selectedAttr := ""

  val selectedAttr: AttrDef = AttrDef(ns, "selected")
